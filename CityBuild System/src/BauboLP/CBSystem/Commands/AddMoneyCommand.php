...
class AddMoneyCommand extends Command
{
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args)
    {
        ...
        CBSystem::getPlugin()->addMoney($player, $args[1]);
        $sender->sendMessage(CBSystem::Prefix.CBSystem::getPlugin()->getTextContainer("money-was-added"));    }
